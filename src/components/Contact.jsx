      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a
              href="mailto:kishansingh.rathore1007@gmail.com"
              target="_blank"
              className="blue-text-gradient"
            >
              kishansingh.rathore1007@gmail.com
            </a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a
              href="https://api.whatsapp.com/send/?phone=916367837526&text&app_absent=0&lang=en"
              target="_blank"
              className="blue-text-gradient"
            >
              +91 6367837526
