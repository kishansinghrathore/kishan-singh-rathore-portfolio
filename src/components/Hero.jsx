    ...
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="flex">
        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm{" "}
              <p className="name text-[#915EFF]">Kishan Singh Rathore</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a href="https://github.com/kishansinghrathore" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/kishan-singh-rathore-8a113628b/"
                target="_blank"
              >
                <ImLinkedin />
              </a>
              <a href="https://www.instagram.com/kpbanna_75" target="_blank">
                <AiOutlineInstagram />
              </a>
        ...
        <div className="imgcontainer1 absolute violet-gradient">
          <img src={kishan} alt="" className="object-contain" />
        </div>
      </div>
