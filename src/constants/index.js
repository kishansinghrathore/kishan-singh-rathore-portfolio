...
const achievements = [
  {
    title:
      "Table Tennis winner at BNY : Secured first position for Singles, Women doubles and Mixed doubles (2024).",
  },
  {
    title:
  ...
  {
    title:
      "SPPU Pune university state level Table-Tennis winner (2021 and 2022).",
  },
  {
    title:
      "1st Position : Consecutive four times Winner of UdChalo Scholarship in AIT Pune (2019 - 2023).",
  },
  {
    title:
      "Branch Head of Information Technology Departmentin in AIT Pune (2021 - 2022).",
  },
  {
    title:
      "Selected in top 100 candidates for Google Cloud Training among 20k Students (2021).",
  },
  {
    title:
      "Got Education Scholarship Scheme for Army Personnel(ESSA) Scholarship for securing 90+ % (2015 - 2023).",
  },
  {
...
const educations = [
  ...
  },
  {
    ...
    branch: "Arts",
    marks: "Percentage : 75 %",
    name: "Adarsh Senior Secondary School Bagot (Kuchaman - Didwana)",
    year: "2022-2023",
    image: school,
  },
  {
